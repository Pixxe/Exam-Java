...
public class Game {
	...
	// Il manque deux privates pour les attributs listeJoueurs et echiquier
		...
		while (!temp2) {
			...
			while (!temp) {
				if (!Roi.getRoiCouleur(jc).isEchec()) {
					// On doit créer le getter de la list tab dans la classe joueur afin d'accèder a
					// l'attribut tab par le getTab
